...
module Openshift.V1.ResourceAccessReview where
...
data ResourceAccessReview = ResourceAccessReview
...
instance Data.Aeson.FromJSON ResourceAccessReview
instance Data.Aeson.ToJSON ResourceAccessReview
