...
module Openshift.V1.Volume where
...
import Openshift.V1.DownwardAPIVolumeSource
import Openshift.V1.EmptyDirVolumeSource
import Openshift.V1.FCVolumeSource
import Openshift.V1.FlockerVolumeSource
import Openshift.V1.GCEPersistentDiskVolumeSource
import Openshift.V1.GitRepoVolumeSource
import Openshift.V1.GlusterfsVolumeSource
import Openshift.V1.HostPathVolumeSource
import Openshift.V1.ISCSIVolumeSource
import Openshift.V1.MetadataVolumeSource
import Openshift.V1.NFSVolumeSource
import Openshift.V1.PersistentVolumeClaimVolumeSource
import Openshift.V1.RBDVolumeSource
import Openshift.V1.SecretVolumeSource
