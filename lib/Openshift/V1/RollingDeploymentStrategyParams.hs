...
data RollingDeploymentStrategyParams = RollingDeploymentStrategyParams
    ...
    , maxUnavailable :: Maybe String -- ^ max number of pods that can be unavailable during the update; value can be an absolute number or a percentage of total pods at start of update 
    , maxSurge :: Maybe String -- ^ max number of pods that can be scheduled above the original number of pods; value can be an absolute number or a percentage of total pods at start of update 
