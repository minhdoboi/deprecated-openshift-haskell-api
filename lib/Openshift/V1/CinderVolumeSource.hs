...
module Openshift.V1.CinderVolumeSource where
...
data CinderVolumeSource = CinderVolumeSource
    ...
    , fsType :: Maybe String -- ^ Required: Filesystem type to mount. Must be a filesystem type supported by the host operating system. Only ext3 and ext4 are allowed More info: http://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md 
