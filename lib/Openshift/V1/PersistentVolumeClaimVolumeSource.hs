...
data PersistentVolumeClaimVolumeSource = PersistentVolumeClaimVolumeSource
    { claimName :: String -- ^ ClaimName is the name of a PersistentVolumeClaim in the same namespace as the pod using this volume. More info: http://releases.k8s.io/HEAD/docs/user-guide/persistent-volumes.md#persistentvolumeclaims 
