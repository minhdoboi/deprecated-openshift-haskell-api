...
data GlusterfsVolumeSource = GlusterfsVolumeSource
    { endpoints :: String -- ^ EndpointsName is the endpoint name that details Glusterfs topology. More info: http://releases.k8s.io/HEAD/examples/glusterfs/README.md#create-a-pod 
    , path :: String -- ^ Path is the Glusterfs volume path. More info: http://releases.k8s.io/HEAD/examples/glusterfs/README.md#create-a-pod 
