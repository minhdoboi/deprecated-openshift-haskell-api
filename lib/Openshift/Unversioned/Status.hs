...
data Status = Status
    ...
    , status :: Maybe String -- ^ Status of the operation. One of: \"Success\" or \"Failure\". More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status 
    , message :: Maybe String -- ^ A human-readable description of the status of this operation. 
    , reason :: Maybe String -- ^ A machine-readable description of why this operation is in the \"Failure\" status. If this value is empty there is no information available. A Reason clarifies an HTTP status code but does not override it. 
